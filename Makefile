...
# source files
SRCS := main.c srcs/uwu.c srcs/parsing.c srcs/palette.c srcs/linear_mapping.c srcs/debug.c srcs/color.c srcs/controls.c srcs/coordinates.c srcs/fractal.c srcs/hooks.c srcs/lifecycle.c srcs/render.c srcs/shapes.c srcs/vector_advanced.c srcs/vector_basics.c srcs/worker.c
